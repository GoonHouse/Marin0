...
downplantintime = 1.8
downplantouttime = 2
downplantanimationdelay = 0.15
downplantmovedist = -24/16
downplantmovespeed = 2.3

redplantintime = 1.2
redplantouttime = 1.5
redplantanimationdelay = 0.15
redplantmovedist = 24/16
redplantmovespeed = 4

reddownplantintime = 1.2
reddownplantouttime = 1.5
