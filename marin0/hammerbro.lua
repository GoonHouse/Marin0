...
function hammerbro:update(dt)
	...
	if self.shot then
		...
		if self.timer <= 0 then
			table.insert(networksendqueue, "hammer;" .. networkclientnumber .. ";" .. self.x .. ";" .. self.y .. ";" .. self.direction)
		...
		if self.timer2 > hammerbrojumptime then
			...
			table.insert(networksendqueue, "brojump;" .. networkclientnumber .. ";" .. dir .. ";" .. bronumber)
